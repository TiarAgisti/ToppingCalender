...
Public Class CrScheduleShift3
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ToppingCalender.CrScheduleShift3.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrScheduleShift3
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrScheduleShift3 = New CrScheduleShift3
        rpt.Site = Me.Site
        Return rpt
    End Function
