...
Public Class CrScheduleShift
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ToppingCalender.CrScheduleShift.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrScheduleShift
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrScheduleShift = New CrScheduleShift
        rpt.Site = Me.Site
        Return rpt
    End Function
