...
Public Class CrRptProduction
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ToppingCalender.CrRptProduction.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrRptProduction
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrRptProduction = New CrRptProduction
        rpt.Site = Me.Site
        Return rpt
    End Function
