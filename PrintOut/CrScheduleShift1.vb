...
Public Class CrScheduleShift1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ToppingCalender.CrScheduleShift1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrScheduleShift1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrScheduleShift1 = New CrScheduleShift1
        rpt.Site = Me.Site
        Return rpt
    End Function
