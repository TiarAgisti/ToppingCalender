...
Public Class CrScheduleShift2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ToppingCalender.CrScheduleShift2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrScheduleShift2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrScheduleShift2 = New CrScheduleShift2
        rpt.Site = Me.Site
        Return rpt
    End Function
